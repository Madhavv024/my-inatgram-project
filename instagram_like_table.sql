...
CREATE TABLE `like_table` (
  `like_tableid` int NOT NULL AUTO_INCREMENT,
  `username` varchar(45) DEFAULT NULL,
  `post_id` int DEFAULT NULL,
  PRIMARY KEY (`like_tableid`),
  KEY `post_id_idx` (`post_id`),
  CONSTRAINT `postid` FOREIGN KEY (`post_id`) REFERENCES `user_post` (`user_postid`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `like_table` VALUES (1,'abc',1);
